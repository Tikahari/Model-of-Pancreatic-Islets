...
#define nrn_init _nrn_init__D_L
#define _nrn_initial _nrn_initial__D_L
#define nrn_cur _nrn_cur__D_L
#define _nrn_current _nrn_current__D_L
#define nrn_jacob _nrn_jacob__D_L
#define nrn_state _nrn_state__D_L
#define _net_receive _net_receive__D_L 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "L_ion");
 	...
 	ivoc_help("help ?1 D_L /ufrc/lamb/robert727/Model-of-Pancreatic-Islets/Build/Watts2016_Delta/x86_64/Delta_L.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/ufrc/lamb/robert727/Model-of-Pancreatic-Islets/Build/Watts2016_Delta/Delta_L.mod";
static const char* nmodl_file_text = 
  "NEURON{\n"
  "SUFFIX D_L\n"
