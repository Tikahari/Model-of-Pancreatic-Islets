...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 D_Kdr /ufrc/lamb/robert727/Model-of-Pancreatic-Islets/Build/Watts2016_Delta/x86_64/Delta_Kdr.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/ufrc/lamb/robert727/Model-of-Pancreatic-Islets/Build/Watts2016_Delta/Delta_Kdr.mod";
static const char* nmodl_file_text = 
  "NEURON{\n"
  "SUFFIX D_Kdr\n"
