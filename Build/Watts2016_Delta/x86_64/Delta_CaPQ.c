...
#define nrn_init _nrn_init__D_CaPQ
#define _nrn_initial _nrn_initial__D_CaPQ
#define nrn_cur _nrn_cur__D_CaPQ
#define _nrn_current _nrn_current__D_CaPQ
#define nrn_jacob _nrn_jacob__D_CaPQ
#define nrn_state _nrn_state__D_CaPQ
#define _net_receive _net_receive__D_CaPQ 
#define states states__D_CaPQ 
...
#define tCaPQh1 _p[5]
#define tCaPQh2 _p[6]
#define mCaPQ_inf _p[7]
#define hCaPQ_inf _p[8]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 D_CaPQ /ufrc/lamb/robert727/Model-of-Pancreatic-Islets/Build/Watts2016_Delta/x86_64/Delta_CaPQ.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/ufrc/lamb/robert727/Model-of-Pancreatic-Islets/Build/Watts2016_Delta/Delta_CaPQ.mod";
static const char* nmodl_file_text = 
  "NEURON{\n"
  "SUFFIX D_CaPQ\n"
