...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
 	...
 	ivoc_help("help ?1 B_BK /ufrc/lamb/robert727/Model-of-Pancreatic-Islets/Build/Temp/x86_64/Beta_BK.mod\n");
 ...
 v=_v;
{
  eCa = _ion_eCa;
 { error =  states();
 if(error){fprintf(stderr,"at line 68 in file Beta_BK.mod:\nSOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 }   _ion_eK = eK;
}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/ufrc/lamb/robert727/Model-of-Pancreatic-Islets/Build/Temp/Beta_BK.mod";
static const char* nmodl_file_text = 
  "NEURON{\n"
  "SUFFIX B_BK\n"
