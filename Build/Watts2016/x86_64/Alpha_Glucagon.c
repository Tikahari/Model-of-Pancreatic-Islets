...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 0, "cvodeieq");
 	...
 	ivoc_help("help ?1 A_Glucagon /ufrc/lamb/tikaharikhanal/Model-of-Pancreatic-Islets/Build/Watts2016/x86_64/Alpha_Glucagon.mod\n");
...
/*CVODE*/
 ...
 static int states (double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt) { {
    G = G + (1. - exp(dt*(( - ( f )*( 1.0 ) ))))*(- ( ( ( Jgs ) / vol ) ) / ( ( - ( f )*( 1.0 ) ) ) - G) ;
   }
  return 0;
}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/ufrc/lamb/tikaharikhanal/Model-of-Pancreatic-Islets/Build/Watts2016/Alpha_Glucagon.mod";
static const char* nmodl_file_text = 
  "NEURON{\n"
  "SUFFIX A_Glucagon\n"
  "RANGE Jgs, vol, f\n"
