...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 B_CaL /ufrc/lamb/robert727/Model-of-Pancreatic-Islets/Build/Fridlyand2012/x86_64/Beta_CaL.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/ufrc/lamb/robert727/Model-of-Pancreatic-Islets/Build/Fridlyand2012/Beta_CaL.mod";
static const char* nmodl_file_text = 
  "NEURON{\n"
  "SUFFIX B_CaL\n"
  "USEION CaL WRITE iCaL VALENCE 2\n"
  ":USEION CaL READ eCaL\n"
  "USEION Vm READ Vmi\n"
  "RANGE dCaL, f1CaL, f2CaL , gmCaL, kdCaL , kfCaL , tf1CaL, tf2CaL, VdCaL, VfCaL\n"
  "RANGE dCaLi, fCaLi, iCaL, tdCaL, eCa\n"
  "}\n"
  "\n"
  "PARAMETER{ \n"
  "gmCaL\n"
