...
#define _ion_iCac	*_ppvar[2]._pval
...
#define _gth 0
#define EK_BK _thread1data[0]
#define EK _thread[_gth]._pval[0]
#define kshift_BK _thread1data[1]
#define kshift _thread[_gth]._pval[1]
...
static void nrn_alloc(Prop* _prop) {
 ...
 prop_ion = need_memb(_Cac_sym);
 	_ppvar[2]._pval = &prop_ion->param[3]; /* iCac */
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 BK /ufrc/lamb/tikaharikhanal/Model-of-Pancreatic-Islets/Build/Fridlyand2012/x86_64/Beta_BK.mod\n");
...
static void _thread_cleanup(Datum* _thread) {
 ...
 static void _update_ion_pointer(Datum* _ppvar) {
   ...
   nrn_update_ion_pointer(_Cac_sym, _ppvar, 2, 3);
 }
