...
#define nrn_init _nrn_init__NaB
#define _nrn_initial _nrn_initial__NaB
#define nrn_cur _nrn_cur__NaB
#define _nrn_current _nrn_current__NaB
#define nrn_jacob _nrn_jacob__NaB
#define nrn_state _nrn_state__NaB
#define _net_receive _net_receive__NaB 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 1, "NaB_ion");
 	...
 	ivoc_help("help ?1 NaB /ufrc/lamb/tikaharikhanal/Model-of-Pancreatic-Islets/Build/Fridlyand2012/x86_64/Beta_NaB.mod\n");
