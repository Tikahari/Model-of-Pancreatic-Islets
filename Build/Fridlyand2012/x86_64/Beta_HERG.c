...
#define nrn_init _nrn_init__HERG
#define _nrn_initial _nrn_initial__HERG
#define nrn_cur _nrn_cur__HERG
#define _nrn_current _nrn_current__HERG
#define nrn_jacob _nrn_jacob__HERG
#define nrn_state _nrn_state__HERG
#define _net_receive _net_receive__HERG 
#define states states__HERG 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "cvodeieq");
 	...
 	ivoc_help("help ?1 HERG /ufrc/lamb/tikaharikhanal/Model-of-Pancreatic-Islets/Build/Fridlyand2012/x86_64/Beta_HERG.mod\n");
