...
#define nrn_init _nrn_init__Ins
#define _nrn_initial _nrn_initial__Ins
#define nrn_cur _nrn_cur__Ins
#define _nrn_current _nrn_current__Ins
#define nrn_jacob _nrn_jacob__Ins
#define nrn_state _nrn_state__Ins
#define _net_receive _net_receive__Ins 
#define states states__Ins 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "cvodeieq");
 	...
 	ivoc_help("help ?1 Ins /ufrc/lamb/tikaharikhanal/Model-of-Pancreatic-Islets/Build/Fridlyand2012/x86_64/Beta_Ins.mod\n");
