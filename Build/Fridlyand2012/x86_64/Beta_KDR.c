...
#define nrn_init _nrn_init__B_KDR
#define _nrn_initial _nrn_initial__B_KDR
#define nrn_cur _nrn_cur__B_KDR
#define _nrn_current _nrn_current__B_KDR
#define nrn_jacob _nrn_jacob__B_KDR
#define nrn_state _nrn_state__B_KDR
#define _net_receive _net_receive__B_KDR 
#define states states__B_KDR 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 B_KDR /ufrc/lamb/tikaharikhanal/Model-of-Pancreatic-Islets/Build/Fridlyand2012/x86_64/Beta_KDR.mod\n");
...
static void _initlists(){
 ...
 int _i; static int _first = 1;
  if (!_first) return;
 _slist1[0] = &(dKr) - _p;  _dlist1[0] = &(DdKr) - _p;
_first = 0;
}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/ufrc/lamb/tikaharikhanal/Model-of-Pancreatic-Islets/Build/Fridlyand2012/Beta_KDR.mod";
static const char* nmodl_file_text = 
  "NEURON{\n"
  "SUFFIX B_KDR\n"
