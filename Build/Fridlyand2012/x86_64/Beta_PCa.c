...
#define nrn_init _nrn_init__PCa
#define _nrn_initial _nrn_initial__PCa
#define nrn_cur _nrn_cur__PCa
#define _nrn_current _nrn_current__PCa
#define nrn_jacob _nrn_jacob__PCa
#define nrn_state _nrn_state__PCa
#define _net_receive _net_receive__PCa 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "PCa_ion");
 	...
 	ivoc_help("help ?1 PCa /ufrc/lamb/tikaharikhanal/Model-of-Pancreatic-Islets/Build/Fridlyand2012/x86_64/Beta_PCa.mod\n");
