...
# glucagon
glucagon = rxd.Species([cyt, ecs], name='glucagon', charge=1, d=1.0, initial=lambda nd: 31 if hasattr(nd, 'sec') and nd.segment in b else 0)
gcyt = glucagon[cyt]
gecs = glucagon[ecs]
...
# insulin
insulin = rxd.Species([cyt, ecs], name='insulin', charge=1, d=1.0, initial=lambda nd: 1500 if hasattr(nd, 'sec') and nd.segment in b else 0)
inscyt = insulin[cyt]
insecs = insulin[ecs]
