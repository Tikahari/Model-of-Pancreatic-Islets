NEURON{
    ...
    RANGE gthresh,sombarb2,sombarb,ssomb,rb,fb,Jgk,factor,gkatpb,bas_r3,amplify,cm,gkca,k4,gkatpbar,kd,nca,raL,vca,vm,sm,gca,vk,gk,vn,sn,taun,kdd,ktd,ktt,fcyt,fer,fmd,kpmca,cbas,B,per,kserca3,kserca2b,sigmav,vmd,vcell,alpha,phigk,KGPDH,k1,k2,k3,f13,f43,f23,f42,f41,lambda,taua,VmaxPFK,kappa,Jgpdh_bas,fmito,gamma,p21,p22,exo_k1,bas_cmd,p23,p24,Amtot,NADmtot
