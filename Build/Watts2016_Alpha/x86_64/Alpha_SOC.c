...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 A_SOC /ufrc/lamb/tikaharikhanal/Model-of-Pancreatic-Islets/Build/Watts2016_Alpha/x86_64/Alpha_SOC.mod\n");
...
static double _nrn_current(double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt, double _v){double _current=0.;v=_v;{ {
   cinf = 1.0 / ( 1.0 + exp ( - ( cer - caerbar ) / ssoc ) ) ;
...
static void _initlists(){
 ...
 int _i; static int _first = 1;
  if (!_first) return;
 _slist1[0] = &(cer) - _p;  _dlist1[0] = &(Dcer) - _p;
_first = 0;
}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/ufrc/lamb/tikaharikhanal/Model-of-Pancreatic-Islets/Build/Watts2016_Alpha/Alpha_SOC.mod";
static const char* nmodl_file_text = 
  "NEURON{\n"
  "SUFFIX A_SOC\n"
  "USEION SOC WRITE iSOC, eSOC VALENCE 2\n"
  "RANGE gsocbar, eSOC, caerbar, ssoca, fer, sigmav \n"
