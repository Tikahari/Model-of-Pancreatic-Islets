...
# set_names removes the higher order path directories from the file name and the extension at the end
# This leaves the files with names like a_21, d_3, etc.
# map_dfc applies the function read_csv to all of the files in the list and then combines them columnwise (i.e., dfr vs. dfr for row)
