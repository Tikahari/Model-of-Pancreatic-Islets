...
USEION Ca READ iCaL
USEION Ca READ iCaR
RANGE G, S, vmd, vcell, alpha, B, kpmca, cbas, kserca2b, kserca3, per, phigk, KGPDH, kappa, Jgk, fcyt, delta, p23 
...
RANGE bas_cmd, max_cmd, cmdp, kcmd, exo_k1, vc, fb : End of parameters
