...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "cvodeieq");
 	...
 	ivoc_help("help ?1 D_Somatostatin /ufrc/lamb/robert727/Model-of-Pancreatic-Islets/Mechanisms/x86_64/Delta_Somatostatin.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/ufrc/lamb/robert727/Model-of-Pancreatic-Islets/Mechanisms/Delta_Somatostatin.mod";
static const char* nmodl_file_text = 
  "NEURON{\n"
