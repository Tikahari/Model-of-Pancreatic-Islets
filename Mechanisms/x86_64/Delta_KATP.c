...
#define nrn_init _nrn_init__D_KATP
#define _nrn_initial _nrn_initial__D_KATP
#define nrn_cur _nrn_cur__D_KATP
#define _nrn_current _nrn_current__D_KATP
#define nrn_jacob _nrn_jacob__D_KATP
#define nrn_state _nrn_state__D_KATP
#define _net_receive _net_receive__D_KATP 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "K_ion");
 	...
 	ivoc_help("help ?1 D_KATP /ufrc/lamb/tikaharikhanal/Model-of-Pancreatic-Islets/Mechanisms/x86_64/Delta_KATP.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/ufrc/lamb/tikaharikhanal/Model-of-Pancreatic-Islets/Mechanisms/Delta_KATP.mod";
static const char* nmodl_file_text = 
  "NEURON{\n"
  "SUFFIX D_KATP\n"
