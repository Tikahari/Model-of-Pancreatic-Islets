...
#define dt _nt->_dt
#define gCaL _p[0]
#define mCaL_inf _p[1]
#define hCaL_inf _p[2]
#define tau_mCaL _p[3]
#define tau_hCaL _p[4]
#define iCaL _p[5]
#define mCaL _p[6]
#define hCaL _p[7]
#define eCa _p[8]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 A_CaL /ufrc/lamb/robert727/Model-of-Pancreatic-Islets/Mechanisms/x86_64/Alpha_CaL.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/ufrc/lamb/robert727/Model-of-Pancreatic-Islets/Mechanisms/Alpha_CaL.mod";
static const char* nmodl_file_text = 
  "NEURON{\n"
  "SUFFIX A_CaL\n"
