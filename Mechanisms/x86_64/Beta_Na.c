...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 B_Na /ufrc/lamb/tikaharikhanal/Model-of-Pancreatic-Islets/Mechanisms/x86_64/Beta_Na.mod\n");
...
static void _initlists(){
 ...
 int _i; static int _first = 1;
  if (!_first) return;
 _slist1[0] = &(dNa) - _p;  _dlist1[0] = &(DdNa) - _p;
 _slist1[1] = &(fNa) - _p;  _dlist1[1] = &(DfNa) - _p;
_first = 0;
}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/ufrc/lamb/tikaharikhanal/Model-of-Pancreatic-Islets/Mechanisms/Beta_Na.mod";
static const char* nmodl_file_text = 
  "NEURON{\n"
  "SUFFIX B_Na \n"
